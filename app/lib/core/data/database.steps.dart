...
final class Schema6 extends i0.VersionedSchema {
  ...
  late final Shape13 edizioni = Shape13(
    source: i0.VersionedTable(
      entityName: 'edizioni',
      withoutRowId: false,
      isStrict: false,
...
class Shape15 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get edizioneId =>
      columnsByName['edizione_id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get creatorId =>
      columnsByName['creator_id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get ruolo =>
      columnsByName['ruolo']! as i1.GeneratedColumn<String>;
}
...
final class Schema8 extends i0.VersionedSchema {
  ...
  late final Shape17 edizioni = Shape17(
    source: i0.VersionedTable(
      entityName: 'edizioni',
      withoutRowId: false,
      isStrict: false,
...
final class Schema10 extends i0.VersionedSchema {
  ...
  late final Shape23 analisiCopertina = Shape23(
    source: i0.VersionedTable(
      entityName: 'analisi_copertina',
      withoutRowId: false,
      isStrict: false,
...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape24 serie = Shape24(
    source: i0.VersionedTable(
      entityName: 'serie',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
      columns: [_column_0, _column_3, _column_4, _column_46, _column_10],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema12 extends i0.VersionedSchema {
  ...
  late final Shape25 conversazione = Shape25(
    source: i0.VersionedTable(
      entityName: 'conversazione',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
  ...
  late final Shape26 messaggio = Shape26(
    source: i0.VersionedTable(
      entityName: 'messaggio',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
      columns: [
...
class Shape26 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get id =>
      columnsByName['id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get conversazioneId =>
      columnsByName['conversazione_id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get ruolo =>
      columnsByName['ruolo']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get sottotipoSistema =>
      columnsByName['sottotipo_sistema']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get testo =>
      columnsByName['testo']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get edizioneIds =>
      columnsByName['edizione_ids']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get createdAt =>
      columnsByName['created_at']! as i1.GeneratedColumn<String>;
}
...
final class Schema13 extends i0.VersionedSchema {
  ...
  late final Shape27 valoreStimato = Shape27(
    source: i0.VersionedTable(
      entityName: 'valore_stimato',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['UNIQUE(copia_id)'],
      columns: [
        _column_0,
        _column_67,
        _column_12,
...
class Shape27 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get id =>
      columnsByName['id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get copiaId =>
      columnsByName['copia_id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get status =>
      columnsByName['status']! as i1.GeneratedColumn<String>;
...
final class Schema14 extends i0.VersionedSchema {
  ...
  late final Shape28 copie = Shape28(
    source: i0.VersionedTable(
      entityName: 'copie',
      withoutRowId: false,
      isStrict: false,
...
class Shape28 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get seller =>
      columnsByName['seller']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<double> get valutazione =>
      columnsByName['valutazione']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<String> get location =>
      columnsByName['location']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get notes =>
      columnsByName['notes']! as i1.GeneratedColumn<String>;
...
final class Schema15 extends i0.VersionedSchema {
  ...
  late final Shape29 copie = Shape29(
    source: i0.VersionedTable(
      entityName: 'copie',
      withoutRowId: false,
      isStrict: false,
...
class Shape29 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get scansioneId =>
      columnsByName['scansione_id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get forSale =>
      columnsByName['for_sale']! as i1.GeneratedColumn<int>;
}
